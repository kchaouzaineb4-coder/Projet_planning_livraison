...
with tab_grouped:
    ...
    # Remplacer les virgules par un saut de ligne dans la colonne Article
    if "Article" in df_liv.columns:
        df_liv["Article"] = df_liv["Article"].astype(str).str.replace(",", "\n")
    
    # Affichage avec largeur adaptable
    show_df(df_liv, use_container_width=True)
