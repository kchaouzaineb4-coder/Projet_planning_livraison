        ...
        if st.button("Exécuter le traitement complet", type="primary"):
            if liv_file and ydlogist_file and wcliegps_file:
                ...
                try:
                    ...
                    st.success("Traitement terminé avec succès ! Vous pouvez maintenant naviguer vers les autres pages.")
                    st.rerun()
...
# PAGE 2: ANALYSE
    ...
    if not st.session_state.data_processed:
        st.warning("⚠️ Veuillez d'abord importer et traiter les données dans la page 'Importation'.")
    else:
        # =====================================================
...
# PAGE 4: VOYAGES
elif st.session_state.current_page == 'voyages':
    if not st.session_state.data_processed:
        st.warning("⚠️ Veuillez d'abord importer et traiter les données dans la page 'Importation'.")
    else:
        # =====================================================
        ...
        try:
            ...
            /* Supprimer l'alternance des coucolors - TOUTES LES LIGNES BLANCHES */
                ...
                if not nom_objet:
                    ...
                    try:
                        ...
                        if success:
                            ...
                            # Synchroniser le gestionnaire de transfert
