...
try:
    ...
    st.info("""
    **Solution :**
    1. Vérifiez que le fichier `backend.py` est dans le même dossier
    2. Vérifiez que `backend.py` contient bien la classe `DeliveryProcessor`
